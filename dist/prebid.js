...
import { processAndLogTaskResults, writeResultsToFile, updateInputFile, writeErrorUrlToFile, } from './utils/results-handler.js';
...
export async function prebidExplorer(options) {
    ...
    for (const taskResult of taskResults) {
        if (taskResult.type === 'no_data') {
            ...
            let errorTypeForFile = 'processing_error';
            ...
            writeErrorUrlToFile(taskResult.url, errorTypeForFile, ERROR_FILES_DIR, logger);
        }
    }
