...
export default class Scan extends Command {
  ...
  public async run(): Promise<void> {
    ...
    if (loggableOptions.puppeteerLaunchOptions) {
      ...
      loggableOptions.puppeteerLaunchOptions = { args: loggableOptions.puppeteerLaunchOptions.args, headless: loggableOptions.puppeteerLaunchOptions.headless };
    }
    ...
    try {
      ...
      if (error instanceof AppError) {
        ...
        logger.error('An unknown error occurred during Prebid scan.', { errorDetail: JSON.stringify(error, null, 2) });
      }
